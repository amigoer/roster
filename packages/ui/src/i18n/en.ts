...
export const en = {
  ...
  "harness.from.machine": "on this machine",
  "harness.from.roster": "downloaded by Roster",
  "harness.from.bundled": "built into Roster",
  "harness.from.custom": "Using the program you picked",
  "harness.elsewhere": "Already installed somewhere else?",
  "harness.pickPath": "Set path",
  "harness.change": "Change",
  "harness.useDefault": "Use default",
  ...
  "harnesses.installFailed": "Install failed; open it to see the output",
