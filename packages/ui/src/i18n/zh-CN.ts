...
export const zhCN = translation<typeof en>()({
  ...
  "harness.program": "程序",
  "harness.from.machine": "本机已装",
  "harness.from.roster": "Roster 下载的",
  "harness.from.bundled": "随 Roster 内置",
  "harness.from.custom": "用你指定的程序",
  "harness.elsewhere": "已经装在别处了？",
  "harness.pickPath": "指定路径",
  "harness.change": "更改",
  "harness.useDefault": "恢复默认",
  ...
  "harnesses.installFailed": "安装失败，点开看输出",
  ...
  "agent.longCache": "提示缓存保留 1 小时",
  "agent.longCacheHint":
    "关：模型 API 在会话安静约 5 分钟后丢掉缓存，下一轮重新读整个上下文。开：保留 1 小时，每次写缓存贵一些；bot 在两轮之间等人的场景划算。对改动之后新开的会话生效。",
  ...
  "tool.compact": "压缩对话",
  "tool.editFiles": "编辑文件",
  "tool.editingFiles": "正在编辑文件",
  "tool.imageGeneration": "生成图片",
  "tool.guardianReview": "Guardian 审查",
  "tool.implementPlan": "按这个方案实施？",
  "tool.sandboxPermissions": "额外的沙箱权限",
  "tool.additionalAnswer": "补充回答或备注",
  "tool.openUrl": "MCP 服务器请求打开链接",
  "steps.count": "{count} 次工具调用",
  "steps.thoughts": "{count} 次思考",
  "steps.thinking": "思考",
  "steps.thought": "思考过程",
  "steps.thoughtLoadFailed": "没能读到这段思考",
  ...
  "composer.placeholderDirect": "发送给 {name}，输入 / 使用命令",
  "composer.add": "添加文件、提及或命令",
  ...
  "session.model": "模型",
  "session.moreModels": "更多模型",
  "session.effort": "思考级别",
  "session.mode": "权限模式",
  "session.fast": "快速模式",
  "session.fastOff.extraUsage": "需要开通额外用量",
  "session.fastOff.free": "免费套餐用不了",
  "session.fastOff.firstParty": "只有 Anthropic 官方渠道能用",
  "session.fastOff.model": "这个模型不支持",
  "session.fastOff.env": "当前环境里关掉了",
  "session.fastOff.preference": "在设置里关掉了",
  "session.fastOff.network": "查不到能不能用",
  "session.fastOff.unknown": "暂时用不了",

  "usage.contextUsed": "上下文已用 {percent}%",
  "usage.planUsed": "套餐已用 {percent}%",
  "usage.plan": "套餐用量",
  "usage.autoCompact": "到 {percent}% 自动压缩",
  "usage.noAutoCompact": "不会自动压缩",
  "usage.cache": "提示缓存",
  "usage.cacheHit": "上一轮输入有 {percent}% 命中缓存",
  "usage.cacheDetail": "读 {read} · 写 {write} · 未缓存 {uncached}",
  "usage.compact": "压缩会话",
  "usage.detail": "查看明细",
