...
| [Agent Client Protocol](https://github.com/agentclientprotocol/typescript-sdk) | Driving Codex, Gemini CLI, Grok Build, OpenCode, DeepSeek Harness, Kimi Code and other ACP agents | Apache-2.0 |
