...
| [Agent Client Protocol](https://github.com/agentclientprotocol/typescript-sdk) | 驱动 Codex、Gemini CLI、Grok Build、OpenCode、DeepSeek Harness、Kimi Code、Qwen Code 这类 agent 的协议 | Apache-2.0 |
